    ...
    <div class="bg-white border-l border-gray-200">
        <div class="py-8 px-4 sm:px-6 lg:px-8">
            <div class="max-w-7xl mx-auto space-y-8 divide-y divide-gray-200">
                <div class="mb-4">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="mt-4 md:mt-0 ml-4">
                            <a href="{{ route('richcms::users.index') }}" class="btn-subtle">Retour</a>
                ...
                <form action="{{ route('richcms::users.update', $user) }}" method="POST" id="form-action">
                    @include('dashui::components.alert')
                    @csrf
                    @method('PUT')
                    @include('richcms::users.form', ['createForm' => false])
                </form>
            </div>
        </div>
    </div>
